...
import type { ComputedLineHours } from '../../domain/contingency';
...
/** Reload the current file and reset its document history. */
async function doReload() {
  ...
  try {
    ...
    documentSync.replaceFromFile(result.data, path);
...
/** Persist the current estimate and apply its saved audit metadata. */
